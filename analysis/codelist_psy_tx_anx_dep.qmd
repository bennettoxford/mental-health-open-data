...
depr_anx_cod <- get_codelist("user/Kunle_Oreagba/psychological-therapies-coding-for-anxiety-and-depression/3f6fc6e3")
...
##### Pattern of Seen by Psychologist Related Codes

```{r}
#| label: Seen by psychologists clinical concepts
#| echo: false
#| message: false
#| warning: false
...
```{r}
#| label: Plot for Seen by Psychologist Codes
#| echo: false
#| message: false
#| warning: false
