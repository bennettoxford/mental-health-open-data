...
This document analyses national SNOMED CT coding patterns for PROMs in anxiety and depression using the opencodecounts R package. The aim is to identify relevant codes, examine usage patterns over time, and explore variation by SNOMED semantic tag.
