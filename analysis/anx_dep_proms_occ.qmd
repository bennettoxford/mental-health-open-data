...
whooley_usage <- snomed_usage |>
  filter_terms(search_teams[["whooley"]]) |> 
  get_semantic_tag()
...
spin_usage <- snomed_usage |>
  filter_terms(search_teams[["spin"]]) |> 
  get_semantic_tag()
...
ibssss_usage <- snomed_usage |>
  filter_terms(search_teams[["ibssss"]]) |> 
  get_semantic_tag()
...
epds_usage <- snomed_usage |>
  filter_terms(search_teams[["epds"]]) |> 
  get_semantic_tag()
...
hdrs_usage <- snomed_usage |>
  filter_terms(search_teams[["hdrs"]]) |> 
  get_semantic_tag()
...
hads_usage <- snomed_usage |>
  filter_terms(search_teams[["hads"]]) |> 
  get_semantic_tag()
