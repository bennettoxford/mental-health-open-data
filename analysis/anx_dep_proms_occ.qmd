...
gtsave(
  ...
  here("output", "tables", "tab_anx_screening_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "fig_proms_anx_screening_trajectory.png"),
...
gtsave(
  ...
  here("output", "tables", "tab_dep_screening_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "fig_proms_dep_screening_trajectory.png"),
