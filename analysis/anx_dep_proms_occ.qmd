...
# Methods
SNOMED CT code usage data for PROMs was extracted from the NHS England SNOMED Code Usage in Primary Care dataset (August 2011–July 2024) using the opencodecounts R package.Search terms were derived from NICE guidelines and NHS Talking Therapies documentation.
