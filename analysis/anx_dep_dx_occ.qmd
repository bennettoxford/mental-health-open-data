---
title: "Depression and anxiety diagnosis code usage"
format: html
editor: visual
---
...
ggsave(
  filename = here("output", "figures", "fig_depr_cod_trends.png"),
  fig_depr_cod_trends,
  height = 4,
  width = 8
)
...
ggsave(
  filename = here("output", "figures", "fig_anx_cod_trends.png"),
  fig_anx_cod_trends,
  height = 4,
  width = 8
)
...
fig_depr_and_cod_trends <- ggplot(
...
ggsave(
  filename = here("output", "figures", "fig_depr_and_cod_trends.png"),
  fig_depr_and_cod_trends,
  height = 4.5,
  width = 8
)
