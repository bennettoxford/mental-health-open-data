...
proms_dep_cod <- get_codelist(
  "user/Lola_O/patient-reported-outcome-measures-for-depression/1f6d6ca4/"
)
...
proms_anx_dep_usage <- snomed_usage |>
  ...
  select(
    start_date, end_date,
    snomed_code, description, usage,
    description_short, semantic_tag,
    proms_anx_cod, proms_dep_cod
  )
```
...
tab_top5_proms_anx_dep_usage <- top5_proms_anx_dep_usage |> 
  ...
  tab_footnote(
    footnote = "Percentage usage for anxiety disorders and depression separately.",
