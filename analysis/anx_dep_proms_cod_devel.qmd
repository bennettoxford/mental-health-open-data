---
title: "Codelist development for PROMs for anxiety disorders and depression"
toc: true
toc-depth: 2
format:
  html:
...
search_terms <- list(
  ...
  dep_screening = c("depression screening", "depression scale")
)
...
This document analyses national SNOMED CT coding patterns for Patient Reported Outcome Measures (PROMs) used to assess symptom severity in anxiety disorders and depression using the _opencodecounts_ R package. The aim is to identify relevant codes, examine usage patterns over time, and explore variation by SNOMED semantic tag (e.g., assessment scale, observable entity, procedure, ...)

# Methods
SNOMED CT code usage data for PROMs was extracted from the NHS England SNOMED Code Usage in Primary Care dataset (August 2011–July 2024) using the _opencodecounts_ R package. Search terms were derived from NICE guidelines ([CG113](https://www.nice.org.uk/guidance/cg113) and [NG222](https://www.nice.org.uk/guidance/ng222)) and [NHS Talking Therapies for anxiety and depression Manual](https://www.england.nhs.uk/wp-content/uploads/2018/06/nhs-talking-therapies-manual-v7.1-updated.pdf).

The analysis included generating a table that summarised total usage counts for each PROM and calculated the proportion of usage by semantic tag to show how recording practices vary by code type. Yearly trajectories of total usage counts were plotted to examine trends over time and identify changes in coding patterns. The overall proportional contribution of each semantic tag across all PROMs was visualised to highlight which code types dominate recording activity.

In all figures and tables, each yearly data point is labelled by its end date (e.g., “July 2024” covers the period from 1 August 2023 to 31 July 2024).

**Note**: All searches used tolower() on both SNOMED CT descriptions and search terms to handle inconsistent spelling and capitalisation (e.g., UK vs US spellings). This improved match rates and helped uncover valid codes that would otherwise be missed.
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_all_proms_trajectory.png"),
  fig_all_proms,
  height = 8,
  width = 8
)
...
gtsave(
  tab_phq_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_phq_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_phq_trajectory.png"),
  fig_phq_trajectory,
  height = 14,
  width = 8
)
...
gtsave(
  tab_bai_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_bai_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_bai_trajectory.png"),
  fig_bai_trajectory,
  height = 5,
  width = 8
)
...
gtsave(
  tab_bdi_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_bdi_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_bdi_trajectory.png"),
  fig_bdi_trajectory,
  height = 7,
  width = 8
)
...
gtsave(
  tab_gad_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_gad_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_gad_trajectory.png"),
  fig_gad_trajectory,
  height = 14,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_whooley_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_whooley_trajectory.png"),
...
gtsave(
  tab_mi_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_mi_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_mi_trajectory.png"),
  fig_mi_trajectory,
  height = 7,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_spin_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_spin_trajectory.png"),
  fig_spin_trajectory,
  height = 7,
  width = 8
)
...
gtsave(
  tab_cfq_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_cfq_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_cfq_trajectory.png"),
  fig_cfq_trajectory,
  height = 5,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_ibssss_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_ibssss_trajectory.png"),
...
gtsave(
  tab_oci_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_oci_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_oci_trajectory.png"),
  fig_oci_trajectory,
  height = 5,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_epds_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_epds_trajectory.png"),
  fig_epds_trajectory,
  height = 2,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_hdrs_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_hdrs_trajectory.png"),
  fig_hdrs_trajectory,
  height = 5,
  width = 8
)
...
gtsave(
  ...
  here("output", "tables", "cod_devel", "proms", "tab_hads_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_hads_trajectory.png"),
  fig_hads_trajectory,
  height = 9,
  width = 8
)
...
gtsave(
  tab_gds_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_gds_sem_tag_usage.png")
  )
...
ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_gds_trajectory.png"),
  fig_gds_trajectory,
  height = 7,
  width = 8
)
...
## Anxiety screening and scale

```{r}
#| label: tab-anx-screening
#| message: false
#| warning: false

# Filter SNOMED usage data
anx_screening_usage <- snomed_usage |>
  filter_terms(search_terms[["anx_screening"]]) |> 
  get_semantic_tag()

# Create usage summary table
anx_screening_summary <- anx_screening_usage |>
  summarise_code_counts()

# Create table grouped by semantic_tag
tab_anx_screening_code_counts <- anx_screening_summary |>
  create_table_sem_tag(
    title = "Summary of Anxiety Screening or Scale related SNOMED codes usage",
    subtitle = "Timeframe: August 2011 to July 2024"
  )

gtsave(
  tab_anx_screening_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_anx_screening_sem_tag_usage.png")
  )
...
```{r}
#| label: fig-anx_screening-trends
#| fig-cap: "Yearly counts of codes with the term 'Anxiety screening' of 'Anxiety scale' in their description from 2011/12 to 2023/24."
#| fig-height: 7
#| fig-width: 8
#| warning: false

fig_anx_screening_trajectory <- plot_trajectory(
  anx_screening_usage,
  ncol_legend = 2)

ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_anx_screening_trajectory.png"),
  fig_anx_screening_trajectory,
  height = 7,
  width = 8
)
...
## Depression screening and scale

```{r}
#| label: tab-dep-screening
#| message: false
#| warning: false

# Filter SNOMED usage data
dep_screening_usage <- snomed_usage |>
  filter_terms(search_terms[["dep_screening"]]) |> 
  get_semantic_tag()

# Create usage summary table
dep_screening_summary <- dep_screening_usage |>
  summarise_code_counts()

# Create table grouped by semantic_tag
tab_dep_screening_code_counts <- dep_screening_summary |>
  create_table_sem_tag(
    title = "Summary of Depression Screening or Scale related SNOMED codes usage",
    subtitle = "Timeframe: August 2011 to July 2024"
  )

gtsave(
  tab_dep_screening_code_counts,
  here("output", "tables", "cod_devel", "proms", "tab_dep_screening_sem_tag_usage.png")
  )
...
```{r}
#| label: fig-dep_screening-trends
#| fig-cap: "Yearly counts of codes with the term 'depression screening' of 'depression scale' in their description from 2011/12 to 2023/24."
#| fig-height: 7
#| fig-width: 8
#| warning: false

# There are so many codes with very little usage
# We decided to only visualise codes with that did not include "Child" in their description
dep_screening_usage_filtered <- dep_screening_usage |> 
  filter(!str_detect(description, "Child"))

fig_dep_screening_trajectory <- plot_trajectory(
  dep_screening_usage_filtered,
  ncol_legend = 1)

ggsave(
  filename = here("output", "figures", "cod_devel", "proms", "fig_proms_dep_screening_trajectory.png"),
  fig_dep_screening_trajectory,
  height = 15,
  width = 8
)
